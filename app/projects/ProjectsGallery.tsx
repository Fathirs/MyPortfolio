...
import { PrimaryButton, SecondaryBackButton } from "@/components/ui/Buttons";
...
// Wrapping in a <Link> turns the whole card into a navigation target — keeps
// keyboard + middle-click + new-tab behaviour for free.
  ...
  return (
    <aside className="flex flex-col gap-[16px] w-[292px] shrink-0">
      ...
      <div className="flex flex-col gap-[12px]">
        ...
        <SecondaryBackButton href="/" label="Back to Homepage" className="w-full justify-center" target="_self" />
      </div>
    </aside>
  );
}
